...
const UI = {
  es: {
    ...
    gemini_step_paste_ok: '✓ Consulta copiada — pégala en el chat con <kbd>Ctrl+V</kbd> / <kbd>⌘V</kbd> y pulsa enviar',
    gemini_step_paste:    'Copia la consulta de abajo y pégala en el chat de Google AI',
    ...
    ask_gemini_btn:             '✦ PREGUNTA A GEMINI',
    gemini_step_attach_gallery: '🖼️ Adjunta la foto de tu tirada desde la galería de tu móvil (icono 📎 en el chat)',
...
- Longitud: entre 250 y 450 palabras, bien organizado en párrafos.`
  ...
  en: {
    ...
    gemini_step_paste_ok: '✓ Query copied — paste it in the chat with <kbd>Ctrl+V</kbd> / <kbd>⌘V</kbd> and press send',
    gemini_step_paste:    'Copy the query below and paste it in the Google AI chat',
    ...
    ask_gemini_btn:             '✦ ASK GEMINI',
    gemini_step_attach_gallery: '🖼️ Attach your spread photo from your phone gallery (📎 icon in the chat)',
